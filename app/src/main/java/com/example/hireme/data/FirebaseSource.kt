...
class FirebaseSource {
    ...
    private fun addJob() {
        val job = Job(
            ...
            Salary = "$ 500K per year",
            Image = "https://firebasestorage.googleapis.com/v0/b/hire-me-b1cc3.appspot.com/o/ProfileImages%2FimgpQbjM8bCjLXPHq6LeupbzdteB3I3?alt=media&token=9ee7077d-3da1-4e93-9124-b54a33d86d22",
            Location = LatLng(22.4100, 31.2222),
            Experience = "> 1 years",
            Type = "Full Time",
            Company = "Juleb",
            Description = "We are looking for someone who works with Kotlin or Java"
        )
        val ref = firebaseDatabase.getReference("Jobs")
        val key = ref.push().key
        job.Id = key
